...
""")
    ...
    def test_case_sensitivity(self, config_parser):
        ...
        they_info_upper = config_parser.getStationInfo("THEY")
        they_info_lower = config_parser.getStationInfo("they")  # Should work the same
        ...
        try:
            they_info_lower = config_parser.getStationInfo("they")
